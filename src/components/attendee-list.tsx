...
export function AttendeeList() {
  ...
  function setCurrentSearch(searchInput: string) {
    const url = new URL(window.location.toString());
    ...
    <div className="flex flex-col gap-4">
      <div className="flex gap-x-3 items-center">
        ...
        <div className="w-72 px-3 py-1.5 border border-white/10  rounded-lg text-sm flex items-center gap-3 ">
          <Search className="size-4 text-eemerald-300" />
          <input
            onChange={onSearchInputChanged}
            value={searchInput}
            className="bg-transparent flex-1 outline-none text-sm border-0 p-0 outline-0 focus:ring-0"
          ...
          {attendees.map((attendee) => {
            return (
              ...
              >
                ...
                <TableCell className="py-3 px-4 text-sm w-24">
                  {attendee.id}
                </TableCell>
                <TableCell>
